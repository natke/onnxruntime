...
python ../../../orttraining/orttraining/test/python/orttraining_test_ortmodule_transformer.py --help
python ../../../orttraining/orttraining/test/python/orttraining_test_ortmodule_transformer.py $@
